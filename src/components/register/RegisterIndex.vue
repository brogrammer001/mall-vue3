        ...
        <template v-slot:contentSlot>
            <div class="register-con">
                <a-space :size="20" direction="vertical" class="register-space">
                    <a-form :model="registerForm" name="register" autocomplete="off" @finish="onFinish" :rules="rules"
                            ...
                            <a-input-password v-model:value="registerForm.affirmPassword" placeholder="确认密码"
                                ...
                                <template #prefix>
                                    <icon :style="{ color: 'hotpink' }">
                                        <template #component>
                                            <svg t="1710300759463" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                                xmlns="http://www.w3.org/2000/svg" p-id="2478" width="14" height="14">
                                                <path
                        ...
                        <a-form-item name="code">
                            <a-input-group compact>
                                ...
                                <a-button type="primary" @click="refreshCode()" style="width: 80px;">{{ authCode
                                    }}</a-button>
                            </a-input-group>
                        </a-form-item>
